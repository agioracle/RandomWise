    ...
    <div className="flex flex-col items-center md:items-start mt-3">
      <div className="flex flex-row gap-3">
        <a
          ...
          className="rounded-full hover:bg-primary/10 text-primary border border-primary w-8 h-8 flex items-center justify-center transition bg-transparent"
        >
          <Twitter className="w-4 h-4 text-primary" fill="none" />
        </a>
        <a
          ...
          className="rounded-full hover:bg-primary/10 text-primary border border-primary w-8 h-8 flex items-center justify-center transition bg-transparent"
        >
          <Facebook className="w-4 h-4 text-primary" fill="none" />
        </a>
        <a
          ...
          className="rounded-full hover:bg-primary/10 text-primary border border-primary w-8 h-8 flex items-center justify-center transition bg-transparent"
        >
          <Linkedin className="w-4 h-4 text-primary" fill="none" />
        </a>
        <a
